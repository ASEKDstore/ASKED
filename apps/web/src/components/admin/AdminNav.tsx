...
import { LayoutDashboard, Package, ShoppingBag, FolderTree, Tag, Megaphone, BarChart3, FlaskConical, Menu, X, Store, Repeat, Warehouse, Boxes } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/polet', label: 'Паллеты', icon: Boxes },
];
